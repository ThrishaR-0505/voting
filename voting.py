...
smtp_port = 587
smtp_user = 'krsthrisha@gmail.com'
smtp_password = 'ksma viya niej zira'  # Use the app-specific password here
...
def cast_vote(politician_name, voter_email):
    ...
    try:
        ...
        # Update the vote count for the politician
...
def log_vote(politician_name, voter_email):
    ...
    # Log in the additional_vote_log.txt file
